...
export const projectsByLang: Record<Language, Project[]> = {
  pt: [
    ...
    {
      title: "Charqscience - Plataforma de Gerenciamento",
      description: "Plataforma web para gerenciamento de eventos científicos, desenvolvida para o IFSul Câmpus Charqueadas.",
      tech: ["PHP", "Laravel", "React", "TailwindCSS", "PostgreSQL"],
      link: "https://github.com/lucasnvs/charqscience-website",
      longDescription: "Projeto desenvolvido para a a matéria de Desenvolvimento de Aplicação como trabalho em grupo, a ideia era criar uma plataforma web para gerenciamento do evento científico realizado anualmente no câmpus, facilitando a organização, inscrição e participação dos usuários. A plataforma conta com funcionalidades como cadastro de eventos, inscrição de participantes, submissão e avaliação de trabalhos científicos, além de painéis administrativos para os organizadores gerenciarem todo o processo.",
      media: [
        { type: "image", src: "/projects/charqscience/lp.png", alt: "Visão geral da Landing Page" },
        { type: "image", src: "/projects/charqscience/login.png", alt: "Visão geral da Landing Page" },
        { type: "image", src: "/projects/charqscience/img-1.png", alt: "Visão geral da Landing Page" },
        { type: "image", src: "/projects/charqscience/img-2.png", alt: "Visão geral" },
        { type: "image", src: "/projects/charqscience/img-3.png", alt: "Visão geral" },
        { type: "image", src: "/projects/charqscience/img-4.png", alt: "Visão geral" },
        { type: "image", src: "/projects/charqscience/student.png", alt: "Visão geral" },
        { type: "image", src: "/projects/charqscience/student-submission.png", alt: "Visão geral" },
        { type: "image", src: "/projects/charqscience/reviewer-dashboard.png", alt: "Visão geral" },
        { type: "image", src: "/projects/charqscience/reviewer-evaluation.png", alt: "Visão geral" },
      ],
    },
    {
      ...
      media: [
        { type: "image", src: "/projects/siboon-web/principal.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/carrinho.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/checkout.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/secao.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/detalhe-produto.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/sobre.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/contato.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/faq.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/entrar.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/perfil.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/admin-dashboard.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/admin-produto.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/admin-edit-produto.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/admin-gerenciar-faq.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/admin-gerenciar-secoes.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/admin-clientes.png", alt: "Visão geral" },
        { type: "image", src: "/projects/siboon-web/admin-config-geral.png", alt: "Visão geral" },
      ],
    },
    {
